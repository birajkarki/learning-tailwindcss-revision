export default function Ellipse2(props: Ellipse2Props) {
  return (
    <div
      className={`w-12 h-12 absolute left-[1185px] top-[2090px] drop-shadow-lg`}
    >
      <svg
        width={"100%"}
        height={"100%"}
        ...
        <defs>
          ...
          >
            ...
            <feBlend
              ...
              result={"effect1_dropShadow_3_1373"}
            ></feBlend>
            <feBlend
              mode={"normal"}
              in={"SourceGraphic"}
              in2={"effect1_dropShadow_3_1373"}
              result={"shape"}
            ></feBlend>
          </filter>
          <linearGradient
            id={"paint0_linear_3_1373"}
            x1={"24"}
            y1={"0"}
            x2={"24"}
            y2={"40"}
