export default function Vector166(props: Vector166Props) {
  return (
    <div
        ...
        <defs>
          ...
          >
            ...
            <feBlend
              ...
              result={"effect1_dropShadow_3_1141"}
            ></feBlend>
            <feBlend
              mode={"normal"}
              in={"SourceGraphic"}
              in2={"effect1_dropShadow_3_1141"}
              result={"shape"}
            ></feBlend>
          </filter>
        </defs>
...
Vector166.defaultProps = {};

interface Vector166Props {}
