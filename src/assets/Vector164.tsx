export default function Vector164(props: Vector164Props) {
  return (
    <div
        ...
        <defs>
          ...
          >
            ...
            <feBlend
              ...
              result={"effect1_dropShadow_3_1135"}
            ></feBlend>
            <feBlend
              mode={"normal"}
              in={"SourceGraphic"}
              in2={"effect1_dropShadow_3_1135"}
              result={"shape"}
            ></feBlend>
          </filter>
        </defs>
...
Vector164.defaultProps = {};

interface Vector164Props {}
